package com.ntt.spring.hibernate.service;
...
import com.ntt.spring.hibernate.pojo.User;
    ...
    public boolean findUser(String uname, String upwd) {
        ...
        try {
            ...
            if(userObj != null && userObj.size() > 0) {
                log.info("Id= " + ((User) userObj.get(0)).getId() + ", Name= " + ((Category) userObj.get(0)).getName() + ", Password= " + ((User) userObj.get(0)).getPassword());
                isValidUser = true;
            }
        } catch(Exception e) {
            isValidUser = false;
